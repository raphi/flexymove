...
package ca.newcommerce.youtube
{
	...
	{		
		...
		protected function initEvents():void
		{
			...
			_wsFeed.addEventListener(VideoDataEvent.VIDEO_INFO_RECEIVED, doVideoLoaded);
		}
		...
		protected function startTest():void
		{
			...
			//var n2:Number = _wsFeed.getStandardFeed(YouTubeFeedClient.STD_MOST_RESPONSED, YouTubeFeedClient.TIME_ALL);
			//trace("n2 " + n2);
			var n:Number = _wsFeed.getVideo("nr7x2bS0bEI");
			trace("Number  "+n);
			_wsFeed.getVideos("cat");
		...
		protected function doVideoLoaded(evt:VideoDataEvent):void
		{
			//DataTracer.traceVideos(evt.video);
			var vd:VideoData = evt.video as VideoData;
			trace("Video " + vd);
			trace("Data " + vd.content + " " + vd.authors);
		}
	}
}