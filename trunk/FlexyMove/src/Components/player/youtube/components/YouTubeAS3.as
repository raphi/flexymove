package Components.player.youtube.components
{
	...
	//  Events
	//--------------------------------------
	[Event(name="youtubeStatus", type="Components.player.youtube.components.YouTubeEvent")]
	[Event(name="youtubePlayerLoaded", type="Components.player.youtube.components.YouTubeEvent")]
	[Event(name="youtubeError", type="Components.player.youtube.components.YouTubeEvent")]
	[Event(name="youtubeVideoQuality", type="Components.player.youtube.components.YouTubeEvent")]
	...
	public class YouTubeAS3 extends UIComponent
	{
		...
		public var playerType : String = "dailymotion" ; //youtube; dailymotion
